...
<div class="navbar flex center">
    ...
    <a href="{{locale_route('client.project.index',$categories[0]->slug)}}" class="nav_item {{str_contains(request()->path(),substr(parse_url(locale_route('client.project.index',$categories[0]->slug), PHP_URL_PATH), 1))?"active":""}}">@lang('client.projects')</a>
